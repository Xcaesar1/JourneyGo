...
class TripRequest(BaseModel):
    ...
    language: str | None = Field(default="zh", description="输出语言(zh/en/ja)", example="en")
...
class Attraction(BaseModel):
    ...
    image_source: str | None = Field(default="", description="图片来源")
    image_author: str | None = Field(default="", description="图片作者")
    image_license: str | None = Field(default="", description="图片许可证")
    image_source_page: str | None = Field(default="", description="图片来源页")
    image_attribution: str | None = Field(default="", description="图片署名文本")
    recommendation_reason: str | None = Field(default="", description="推荐理由")
    ticket_price: int = Field(default=0, description="门票价格(元)")
    reservation_required: bool | None = Field(default=False, description="是否需要提前预约")
    reservation_tips: str | None = Field(default="", description="预约提示信息")
...
class DayPlan(BaseModel):
    ...
    transfer_info: str | None = Field(default="", description="城际交通信息")
...
class TripPlan(BaseModel):
    ...
    research_updated_at: datetime | None = Field(default=None, description="来源最近抓取时间")
...
class GraphNode(BaseModel):
    ...
    itemStyle: dict | None = Field(default=None, description="节点样式")
    value: str | None = Field(default="", description="附加信息")
...
class TripPlanResponse(BaseModel):
    ...
    plan_id: str | None = Field(default=None, description="计划ID（与后端任务ID对齐）")
    data: TripPlan | None = Field(default=None, description="旅行计划数据")
    graph_data: KnowledgeGraphData | None = Field(default=None, description="知识图谱数据")
...
class TripChatRequest(BaseModel):
    ...
    history: list[ChatMessage] | None = Field(default_factory=list, description="历史对话记录")
