            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Preserve all verified is_landmark candidates unless explicitly excluded. Rank user-required "
                        "places before landmarks, then interests and other places. Respect experience_group deduplication "
                        "and recommended_minutes; never squeeze a half/full-day sight into 90 minutes. "
