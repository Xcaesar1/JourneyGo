<template>
  <a-config-provider :locale="componentLocale">
  <div id="app">
...
const componentLocales = { 'zh-CN': zhCN, 'ja-JP': jaJP, 'en-US': enUS, 'ko-KR': koKR }
const dateLocales = { 'zh-CN': 'zh-cn', 'ja-JP': 'ja', 'en-US': 'en', 'ko-KR': 'ko' }
const componentLocale = computed(() => componentLocales[locale.value as AppLocale])

watch(
  locale,
  (nextLocale) => {
    setAppLocale(nextLocale as AppLocale)
    dayjs.locale(dateLocales[nextLocale as AppLocale])
