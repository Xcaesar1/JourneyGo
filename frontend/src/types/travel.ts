...
export type TravelCapabilities = Record<TravelProvider, { enabled: boolean; paid: boolean; city_codes?: Record<string, string> }> & { one_click?: { enabled: boolean; paid: boolean } }
