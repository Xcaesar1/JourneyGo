...
<style scoped>
.trip-navigator { padding: 20px; margin-bottom: 24px; border: 1px solid #80624d; border-radius: 16px; background: linear-gradient(125deg, #aa724018, transparent 70%); color: inherit; }
...
select { max-width: 100%; min-height: 44px; border-radius: 8px; padding: 8px; background: #19232a; color: #fff; border: 1px solid #80624d; }
.navigator-note, small { opacity: .75; font-size: 13px; }
.next-stop { border-left: 3px solid #dca171; padding: 12px 16px; margin: 16px 0; }
.progress-actions { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 12px; }
button { min-height: 44px; border: 1px solid #80624d; border-radius: 8px; padding: 8px 12px; background: transparent; color: inherit; cursor: pointer; font: inherit; }
button:focus-visible, summary:focus-visible, select:focus-visible { outline: 2px solid #df9766; outline-offset: 2px; }
summary { cursor: pointer; padding: 12px 0; }
ol { padding-left: 24px; }
li { padding: 12px 0; border-bottom: 1px solid #80624d55; overflow-wrap: anywhere; }
